...
type QuotationCreateParams struct {
	...
	// 見積内容
	QuotationContents []InvoiceCreateParamsInvoiceContentsInner `json:"quotation_contents,omitempty"`
...
// SetQuotationContents gets a reference to the given []InvoiceCreateParamsInvoiceContentsInner and assigns it to the QuotationContents field.
