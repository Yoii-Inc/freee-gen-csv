...
// TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner struct for TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner
type TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner struct {
	// 期末残高
...
func NewTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner(id int64) *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner {
	this := TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner{}
	this.Id = id
	return &this
}
...
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) GetClosingBalance() int64 {
...
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) GetClosingBalanceOk() (*int64, bool) {
	if o == nil || o.ClosingBalance == nil {
		return nil, false
	}
...
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) SetClosingBalance(v int64) {
	o.ClosingBalance = &v
}

// GetId returns the Id field value
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) GetId() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) GetIdOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) SetId(v int64) {
	o.Id = v
}

// GetLastYearClosingBalance returns the LastYearClosingBalance field value if set, zero value otherwise.
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) GetLastYearClosingBalance() int64 {
...
// and a boolean to check if the value has been set.
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) GetLastYearClosingBalanceOk() (*int64, bool) {
	if o == nil || o.LastYearClosingBalance == nil {
		return nil, false
	}
...
func (o *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) SetLastYearClosingBalance(v int64) {
...
func (o TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner struct {
	value *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner
	isSet bool
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) Get() *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner {
	return v.value
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) Set(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner {
	return &NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner{value: val, isSet: true}
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment2TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
