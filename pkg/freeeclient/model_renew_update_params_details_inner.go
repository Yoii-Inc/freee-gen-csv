...
// RenewUpdateParamsDetailsInner struct for RenewUpdateParamsDetailsInner
type RenewUpdateParamsDetailsInner struct {
	// 勘定科目ID
...
func NewRenewUpdateParamsDetailsInner(accountItemId int64, amount int64, taxCode int64) *RenewUpdateParamsDetailsInner {
	this := RenewUpdateParamsDetailsInner{}
...
func (o RenewUpdateParamsDetailsInner) MarshalJSON() ([]byte, error) {
...
type NullableRenewUpdateParamsDetailsInner struct {
	value *RenewUpdateParamsDetailsInner
	isSet bool
}

func (v NullableRenewUpdateParamsDetailsInner) Get() *RenewUpdateParamsDetailsInner {
	return v.value
}

func (v *NullableRenewUpdateParamsDetailsInner) Set(val *RenewUpdateParamsDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRenewUpdateParamsDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRenewUpdateParamsDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenewUpdateParamsDetailsInner(val *RenewUpdateParamsDetailsInner) *NullableRenewUpdateParamsDetailsInner {
	return &NullableRenewUpdateParamsDetailsInner{value: val, isSet: true}
}

func (v NullableRenewUpdateParamsDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenewUpdateParamsDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
