...
// TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner struct for TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner
type TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner struct {
	// 勘定科目カテゴリー名
	...
	// セグメント3タグ
	Segment3Tags []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInnerSegment3TagsInner `json:"segment_3_tags,omitempty"`
...
func NewTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner() *TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner {
	this := TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner{}
	return &this
}
...
func (o *TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) GetSegment3Tags() []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInnerSegment3TagsInner {
	if o == nil || o.Segment3Tags == nil {
		var ret []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInnerSegment3TagsInner
		return ret
	}
...
// SetSegment3Tags gets a reference to the given []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInnerSegment3TagsInner and assigns it to the Segment3Tags field.
...
func (o TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner struct {
	value *TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner
	isSet bool
}

func (v NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) Get() *TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner {
	return v.value
}

func (v *NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) Set(val *TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner(val *TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) *NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner {
	return &NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner{value: val, isSet: true}
}

func (v NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
