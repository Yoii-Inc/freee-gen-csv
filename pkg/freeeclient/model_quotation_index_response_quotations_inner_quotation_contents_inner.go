...
func (o *QuotationIndexResponseQuotationsInnerQuotationContentsInner) SetSegment1TagIdNil() {
...
func (o *QuotationIndexResponseQuotationsInnerQuotationContentsInner) SetSegment1TagNameNil() {
...
func (o *QuotationIndexResponseQuotationsInnerQuotationContentsInner) SetSegment2TagIdNil() {
...
func (o *QuotationIndexResponseQuotationsInnerQuotationContentsInner) SetSegment2TagNameNil() {
...
func (o *QuotationIndexResponseQuotationsInnerQuotationContentsInner) SetSegment3TagIdNil() {
...
func (o *QuotationIndexResponseQuotationsInnerQuotationContentsInner) SetSegment3TagNameNil() {
...
func (o QuotationIndexResponseQuotationsInnerQuotationContentsInner) MarshalJSON() ([]byte, error) {
...
type NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner struct {
	value *QuotationIndexResponseQuotationsInnerQuotationContentsInner
	isSet bool
}

func (v NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner) Get() *QuotationIndexResponseQuotationsInnerQuotationContentsInner {
	return v.value
}

func (v *NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner) Set(val *QuotationIndexResponseQuotationsInnerQuotationContentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuotationIndexResponseQuotationsInnerQuotationContentsInner(val *QuotationIndexResponseQuotationsInnerQuotationContentsInner) *NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner {
	return &NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner{value: val, isSet: true}
}

func (v NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuotationIndexResponseQuotationsInnerQuotationContentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
