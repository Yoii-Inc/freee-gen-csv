...
// DealReceiptsInnerUser struct for DealReceiptsInnerUser
type DealReceiptsInnerUser struct {
	// 表示名
...
func (o *DealReceiptsInnerUser) SetDisplayNameNil() {
...
func (o DealReceiptsInnerUser) MarshalJSON() ([]byte, error) {
...
type NullableDealReceiptsInnerUser struct {
	value *DealReceiptsInnerUser
	isSet bool
}

func (v NullableDealReceiptsInnerUser) Get() *DealReceiptsInnerUser {
	return v.value
}

func (v *NullableDealReceiptsInnerUser) Set(val *DealReceiptsInnerUser) {
	v.value = val
	v.isSet = true
}

func (v NullableDealReceiptsInnerUser) IsSet() bool {
	return v.isSet
}

func (v *NullableDealReceiptsInnerUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealReceiptsInnerUser(val *DealReceiptsInnerUser) *NullableDealReceiptsInnerUser {
	return &NullableDealReceiptsInnerUser{value: val, isSet: true}
}

func (v NullableDealReceiptsInnerUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealReceiptsInnerUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
