...
// GetTaxesCompanies200ResponseTaxesInner struct for GetTaxesCompanies200ResponseTaxesInner
type GetTaxesCompanies200ResponseTaxesInner struct {
...
func (o GetTaxesCompanies200ResponseTaxesInner) MarshalJSON() ([]byte, error) {
...
type NullableGetTaxesCompanies200ResponseTaxesInner struct {
	value *GetTaxesCompanies200ResponseTaxesInner
	isSet bool
}

func (v NullableGetTaxesCompanies200ResponseTaxesInner) Get() *GetTaxesCompanies200ResponseTaxesInner {
	return v.value
}

func (v *NullableGetTaxesCompanies200ResponseTaxesInner) Set(val *GetTaxesCompanies200ResponseTaxesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTaxesCompanies200ResponseTaxesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTaxesCompanies200ResponseTaxesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTaxesCompanies200ResponseTaxesInner(val *GetTaxesCompanies200ResponseTaxesInner) *NullableGetTaxesCompanies200ResponseTaxesInner {
	return &NullableGetTaxesCompanies200ResponseTaxesInner{value: val, isSet: true}
}

func (v NullableGetTaxesCompanies200ResponseTaxesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTaxesCompanies200ResponseTaxesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
