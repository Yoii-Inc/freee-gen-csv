...
// TrialCrSectionsResponseTrialCrSectionsBalancesInner struct for TrialCrSectionsResponseTrialCrSectionsBalancesInner
type TrialCrSectionsResponseTrialCrSectionsBalancesInner struct {
	// 勘定科目カテゴリー名
	...
	// 部門
	Sections []TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInner `json:"sections,omitempty"`
...
func NewTrialCrSectionsResponseTrialCrSectionsBalancesInner() *TrialCrSectionsResponseTrialCrSectionsBalancesInner {
	this := TrialCrSectionsResponseTrialCrSectionsBalancesInner{}
	return &this
}
...
func (o *TrialCrSectionsResponseTrialCrSectionsBalancesInner) GetSections() []TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInner {
	if o == nil || o.Sections == nil {
		var ret []TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInner
		return ret
	}
	return o.Sections
}
...
// SetSections gets a reference to the given []TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInner and assigns it to the Sections field.
...
func (o TrialCrSectionsResponseTrialCrSectionsBalancesInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner struct {
	value *TrialCrSectionsResponseTrialCrSectionsBalancesInner
	isSet bool
}

func (v NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner) Get() *TrialCrSectionsResponseTrialCrSectionsBalancesInner {
	return v.value
}

func (v *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner) Set(val *TrialCrSectionsResponseTrialCrSectionsBalancesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSectionsResponseTrialCrSectionsBalancesInner(val *TrialCrSectionsResponseTrialCrSectionsBalancesInner) *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner {
	return &NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner{value: val, isSet: true}
}

func (v NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
