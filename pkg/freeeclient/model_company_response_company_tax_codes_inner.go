...
// CompanyResponseCompanyTaxCodesInner struct for CompanyResponseCompanyTaxCodesInner
type CompanyResponseCompanyTaxCodesInner struct {
	// 税区分コード
...
func NewCompanyResponseCompanyTaxCodesInner(code int32, name string, nameJa string) *CompanyResponseCompanyTaxCodesInner {
	this := CompanyResponseCompanyTaxCodesInner{}
	this.Code = code
	this.Name = name
	this.NameJa = nameJa
	return &this
...
func (o CompanyResponseCompanyTaxCodesInner) MarshalJSON() ([]byte, error) {
...
type NullableCompanyResponseCompanyTaxCodesInner struct {
	value *CompanyResponseCompanyTaxCodesInner
	isSet bool
}

func (v NullableCompanyResponseCompanyTaxCodesInner) Get() *CompanyResponseCompanyTaxCodesInner {
	return v.value
}

func (v *NullableCompanyResponseCompanyTaxCodesInner) Set(val *CompanyResponseCompanyTaxCodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyResponseCompanyTaxCodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyResponseCompanyTaxCodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyResponseCompanyTaxCodesInner(val *CompanyResponseCompanyTaxCodesInner) *NullableCompanyResponseCompanyTaxCodesInner {
	return &NullableCompanyResponseCompanyTaxCodesInner{value: val, isSet: true}
}

func (v NullableCompanyResponseCompanyTaxCodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyResponseCompanyTaxCodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
