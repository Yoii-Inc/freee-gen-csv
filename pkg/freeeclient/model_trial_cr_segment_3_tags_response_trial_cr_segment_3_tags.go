...
// TrialCrSegment3TagsResponseTrialCrSegment3Tags struct for TrialCrSegment3TagsResponseTrialCrSegment3Tags
type TrialCrSegment3TagsResponseTrialCrSegment3Tags struct {
	...
	Balances []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner `json:"balances"`
	...
	// 出力するセグメント3の指定
	Segment3TagIds string `json:"segment_3_tag_ids"`
...
func NewTrialCrSegment3TagsResponseTrialCrSegment3Tags(balances []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner, companyId int32, segment3TagIds string) *TrialCrSegment3TagsResponseTrialCrSegment3Tags {
	this := TrialCrSegment3TagsResponseTrialCrSegment3Tags{}
...
func (o *TrialCrSegment3TagsResponseTrialCrSegment3Tags) GetBalances() []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner {
	if o == nil {
		var ret []TrialCrSegment3TagsResponseTrialCrSegment3TagsBalancesInner
		return ret
	}
...
// GetSegment3TagIds returns the Segment3TagIds field value
func (o *TrialCrSegment3TagsResponseTrialCrSegment3Tags) GetSegment3TagIds() string {
	...
	return o.Segment3TagIds
}

// GetSegment3TagIdsOk returns a tuple with the Segment3TagIds field value
// and a boolean to check if the value has been set.
func (o *TrialCrSegment3TagsResponseTrialCrSegment3Tags) GetSegment3TagIdsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Segment3TagIds, true
}

// SetSegment3TagIds sets field value
...
func (o TrialCrSegment3TagsResponseTrialCrSegment3Tags) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["segment_3_tag_ids"] = o.Segment3TagIds
	}
	if o.StartDate != nil {
...
type NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags struct {
	value *TrialCrSegment3TagsResponseTrialCrSegment3Tags
	isSet bool
}

func (v NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags) Get() *TrialCrSegment3TagsResponseTrialCrSegment3Tags {
	return v.value
}

func (v *NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags) Set(val *TrialCrSegment3TagsResponseTrialCrSegment3Tags) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSegment3TagsResponseTrialCrSegment3Tags(val *TrialCrSegment3TagsResponseTrialCrSegment3Tags) *NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags {
	return &NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags{value: val, isSet: true}
}

func (v NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSegment3TagsResponseTrialCrSegment3Tags) UnmarshalJSON(src []byte) error {
	v.isSet = true
