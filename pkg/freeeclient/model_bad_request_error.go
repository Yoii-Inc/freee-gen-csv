...
type BadRequestError struct {
	Errors []BadRequestErrorErrorsInner `json:"errors,omitempty"`
...
func (o *BadRequestError) GetErrors() []BadRequestErrorErrorsInner {
	if o == nil || o.Errors == nil {
		var ret []BadRequestErrorErrorsInner
		return ret
	}
	return o.Errors
}
...
// SetErrors gets a reference to the given []BadRequestErrorErrorsInner and assigns it to the Errors field.
