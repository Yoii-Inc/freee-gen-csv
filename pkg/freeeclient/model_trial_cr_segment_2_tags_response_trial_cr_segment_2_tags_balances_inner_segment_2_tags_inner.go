...
func (o TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner struct {
	value *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner
	isSet bool
}

func (v NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) Get() *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner {
	return v.value
}

func (v *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) Set(val *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner(val *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner {
	return &NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner{value: val, isSet: true}
}

func (v NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
