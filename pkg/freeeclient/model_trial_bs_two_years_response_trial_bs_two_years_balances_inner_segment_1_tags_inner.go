...
// TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner struct for TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner
type TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner struct {
	// 期末残高
...
func NewTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner(id int32) *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner {
	this := TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner struct {
	value *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner
	isSet bool
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) Get() *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner {
	return v.value
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) Set(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner {
	return &NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner{value: val, isSet: true}
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment1TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
