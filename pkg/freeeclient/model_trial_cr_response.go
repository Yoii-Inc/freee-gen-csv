...
// TrialCrResponse struct for TrialCrResponse
type TrialCrResponse struct {
	TrialCr TrialCrResponseTrialCr `json:"trial_cr"`
	// 集計結果が最新かどうか
...
// GetTrialCr returns the TrialCr field value
func (o *TrialCrResponse) GetTrialCr() TrialCrResponseTrialCr {
	if o == nil {
		var ret TrialCrResponseTrialCr
		return ret
	}
...
// GetTrialCrOk returns a tuple with the TrialCr field value
// and a boolean to check if the value has been set.
func (o *TrialCrResponse) GetTrialCrOk() (*TrialCrResponseTrialCr, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TrialCr, true
}

// SetTrialCr sets field value
...
func (o TrialCrResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["trial_cr"] = o.TrialCr
	}
	if true {
...
type NullableTrialCrResponse struct {
	value *TrialCrResponse
	isSet bool
}

func (v NullableTrialCrResponse) Get() *TrialCrResponse {
	return v.value
}

func (v *NullableTrialCrResponse) Set(val *TrialCrResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrResponse(val *TrialCrResponse) *NullableTrialCrResponse {
	return &NullableTrialCrResponse{value: val, isSet: true}
}

func (v NullableTrialCrResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
