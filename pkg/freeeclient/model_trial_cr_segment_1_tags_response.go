...
// TrialCrSegment1TagsResponse struct for TrialCrSegment1TagsResponse
type TrialCrSegment1TagsResponse struct {
	TrialCrSegment1Tags TrialCrSegment1TagsResponseTrialCrSegment1Tags `json:"trial_cr_segment_1_tags"`
	// 集計結果が最新かどうか
...
func NewTrialCrSegment1TagsResponse(trialCrSegment1Tags TrialCrSegment1TagsResponseTrialCrSegment1Tags, upToDate bool) *TrialCrSegment1TagsResponse {
	this := TrialCrSegment1TagsResponse{}
...
// GetTrialCrSegment1Tags returns the TrialCrSegment1Tags field value
...
func (o TrialCrSegment1TagsResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["trial_cr_segment_1_tags"] = o.TrialCrSegment1Tags
	}
	if true {
...
type NullableTrialCrSegment1TagsResponse struct {
	value *TrialCrSegment1TagsResponse
	isSet bool
}

func (v NullableTrialCrSegment1TagsResponse) Get() *TrialCrSegment1TagsResponse {
	return v.value
}

func (v *NullableTrialCrSegment1TagsResponse) Set(val *TrialCrSegment1TagsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSegment1TagsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSegment1TagsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSegment1TagsResponse(val *TrialCrSegment1TagsResponse) *NullableTrialCrSegment1TagsResponse {
	return &NullableTrialCrSegment1TagsResponse{value: val, isSet: true}
}

func (v NullableTrialCrSegment1TagsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSegment1TagsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
