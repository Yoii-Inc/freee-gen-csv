...
func (o RenewCreateParamsDetailsInner) MarshalJSON() ([]byte, error) {
...
type NullableRenewCreateParamsDetailsInner struct {
	value *RenewCreateParamsDetailsInner
	isSet bool
}

func (v NullableRenewCreateParamsDetailsInner) Get() *RenewCreateParamsDetailsInner {
	return v.value
}

func (v *NullableRenewCreateParamsDetailsInner) Set(val *RenewCreateParamsDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRenewCreateParamsDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRenewCreateParamsDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenewCreateParamsDetailsInner(val *RenewCreateParamsDetailsInner) *NullableRenewCreateParamsDetailsInner {
	return &NullableRenewCreateParamsDetailsInner{value: val, isSet: true}
}

func (v NullableRenewCreateParamsDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenewCreateParamsDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
