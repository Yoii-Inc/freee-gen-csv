...
// DealPaymentsInner struct for DealPaymentsInner
type DealPaymentsInner struct {
	// 支払金額
...
func (o DealPaymentsInner) MarshalJSON() ([]byte, error) {
...
type NullableDealPaymentsInner struct {
	value *DealPaymentsInner
	isSet bool
}

func (v NullableDealPaymentsInner) Get() *DealPaymentsInner {
	return v.value
}

func (v *NullableDealPaymentsInner) Set(val *DealPaymentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDealPaymentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDealPaymentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealPaymentsInner(val *DealPaymentsInner) *NullableDealPaymentsInner {
	return &NullableDealPaymentsInner{value: val, isSet: true}
}

func (v NullableDealPaymentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealPaymentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
