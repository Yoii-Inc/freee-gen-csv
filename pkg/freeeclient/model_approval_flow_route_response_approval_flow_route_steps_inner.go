...
// ApprovalFlowRouteResponseApprovalFlowRouteStepsInner struct for ApprovalFlowRouteResponseApprovalFlowRouteStepsInner
type ApprovalFlowRouteResponseApprovalFlowRouteStepsInner struct {
	// 承認ステップID
	Id int64 `json:"id"`
	// 次の承認ステップID
	NextStepId NullableInt64 `json:"next_step_id"`
...
func NewApprovalFlowRouteResponseApprovalFlowRouteStepsInner(id int64, nextStepId NullableInt64, resourceType string) *ApprovalFlowRouteResponseApprovalFlowRouteStepsInner {
	this := ApprovalFlowRouteResponseApprovalFlowRouteStepsInner{}
	this.Id = id
...
func (o ApprovalFlowRouteResponseApprovalFlowRouteStepsInner) MarshalJSON() ([]byte, error) {
...
type NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner struct {
	value *ApprovalFlowRouteResponseApprovalFlowRouteStepsInner
	isSet bool
}

func (v NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner) Get() *ApprovalFlowRouteResponseApprovalFlowRouteStepsInner {
	return v.value
}

func (v *NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner) Set(val *ApprovalFlowRouteResponseApprovalFlowRouteStepsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner(val *ApprovalFlowRouteResponseApprovalFlowRouteStepsInner) *NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner {
	return &NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner{value: val, isSet: true}
}

func (v NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalFlowRouteResponseApprovalFlowRouteStepsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
