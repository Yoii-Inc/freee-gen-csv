...
// TrialPlSegment3TagsResponse struct for TrialPlSegment3TagsResponse
type TrialPlSegment3TagsResponse struct {
	TrialPlSegment3Tags TrialCrSegment3TagsResponseTrialCrSegment3Tags `json:"trial_pl_segment_3_tags"`
	// 集計結果が最新かどうか
...
func NewTrialPlSegment3TagsResponse(trialPlSegment3Tags TrialCrSegment3TagsResponseTrialCrSegment3Tags, upToDate bool) *TrialPlSegment3TagsResponse {
	this := TrialPlSegment3TagsResponse{}
...
func (o TrialPlSegment3TagsResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["trial_pl_segment_3_tags"] = o.TrialPlSegment3Tags
	}
	if true {
...
type NullableTrialPlSegment3TagsResponse struct {
	value *TrialPlSegment3TagsResponse
	isSet bool
}

func (v NullableTrialPlSegment3TagsResponse) Get() *TrialPlSegment3TagsResponse {
	return v.value
}

func (v *NullableTrialPlSegment3TagsResponse) Set(val *TrialPlSegment3TagsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialPlSegment3TagsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialPlSegment3TagsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialPlSegment3TagsResponse(val *TrialPlSegment3TagsResponse) *NullableTrialPlSegment3TagsResponse {
	return &NullableTrialPlSegment3TagsResponse{value: val, isSet: true}
}

func (v NullableTrialPlSegment3TagsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialPlSegment3TagsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
