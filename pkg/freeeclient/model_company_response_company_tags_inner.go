...
// CompanyResponseCompanyTagsInner struct for CompanyResponseCompanyTagsInner
type CompanyResponseCompanyTagsInner struct {
	// タグID
	Id int64 `json:"id"`
	// 名前(30文字以内)
...
func NewCompanyResponseCompanyTagsInner(id int64, name string) *CompanyResponseCompanyTagsInner {
	this := CompanyResponseCompanyTagsInner{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *CompanyResponseCompanyTagsInner) SetShortcut1Nil() {
	o.Shortcut1.Set(nil)
}
...
func (o *CompanyResponseCompanyTagsInner) SetShortcut2Nil() {
	o.Shortcut2.Set(nil)
}
...
func (o CompanyResponseCompanyTagsInner) MarshalJSON() ([]byte, error) {
...
type NullableCompanyResponseCompanyTagsInner struct {
	value *CompanyResponseCompanyTagsInner
	isSet bool
}

func (v NullableCompanyResponseCompanyTagsInner) Get() *CompanyResponseCompanyTagsInner {
	return v.value
}

func (v *NullableCompanyResponseCompanyTagsInner) Set(val *CompanyResponseCompanyTagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyResponseCompanyTagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyResponseCompanyTagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyResponseCompanyTagsInner(val *CompanyResponseCompanyTagsInner) *NullableCompanyResponseCompanyTagsInner {
	return &NullableCompanyResponseCompanyTagsInner{value: val, isSet: true}
}

func (v NullableCompanyResponseCompanyTagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyResponseCompanyTagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
