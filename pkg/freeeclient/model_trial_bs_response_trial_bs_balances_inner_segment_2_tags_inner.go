...
// TrialBsResponseTrialBsBalancesInnerSegment2TagsInner struct for TrialBsResponseTrialBsBalancesInnerSegment2TagsInner
type TrialBsResponseTrialBsBalancesInnerSegment2TagsInner struct {
	// 期末残高
...
func NewTrialBsResponseTrialBsBalancesInnerSegment2TagsInner(id int32) *TrialBsResponseTrialBsBalancesInnerSegment2TagsInner {
	this := TrialBsResponseTrialBsBalancesInnerSegment2TagsInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsResponseTrialBsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner struct {
	value *TrialBsResponseTrialBsBalancesInnerSegment2TagsInner
	isSet bool
}

func (v NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner) Get() *TrialBsResponseTrialBsBalancesInnerSegment2TagsInner {
	return v.value
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner) Set(val *TrialBsResponseTrialBsBalancesInnerSegment2TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner(val *TrialBsResponseTrialBsBalancesInnerSegment2TagsInner) *NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner {
	return &NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner{value: val, isSet: true}
}

func (v NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerSegment2TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
