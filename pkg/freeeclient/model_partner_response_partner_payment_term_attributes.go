...
// PartnerResponsePartnerPaymentTermAttributes struct for PartnerResponsePartnerPaymentTermAttributes
type PartnerResponsePartnerPaymentTermAttributes struct {
	// 支払月
...
func NewPartnerResponsePartnerPaymentTermAttributes() *PartnerResponsePartnerPaymentTermAttributes {
	this := PartnerResponsePartnerPaymentTermAttributes{}
	return &this
}
...
func (o *PartnerResponsePartnerPaymentTermAttributes) GetAdditionalMonthsOk() (*int64, bool) {
	...
	return o.AdditionalMonths.Get(), o.AdditionalMonths.IsSet()
}
...
func (o *PartnerResponsePartnerPaymentTermAttributes) HasAdditionalMonths() bool {
	if o != nil && o.AdditionalMonths.IsSet() {
		return true
	}
...
func (o *PartnerResponsePartnerPaymentTermAttributes) SetAdditionalMonthsNil() {
	o.AdditionalMonths.Set(nil)
}
...
func (o *PartnerResponsePartnerPaymentTermAttributes) GetCutoffDayOk() (*int64, bool) {
	...
	return o.CutoffDay.Get(), o.CutoffDay.IsSet()
}
...
func (o *PartnerResponsePartnerPaymentTermAttributes) SetCutoffDayNil() {
	o.CutoffDay.Set(nil)
}
...
func (o *PartnerResponsePartnerPaymentTermAttributes) SetFixedDayNil() {
	o.FixedDay.Set(nil)
}
...
func (o PartnerResponsePartnerPaymentTermAttributes) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.AdditionalMonths.IsSet() {
		toSerialize["additional_months"] = o.AdditionalMonths.Get()
	}
	if o.CutoffDay.IsSet() {
		toSerialize["cutoff_day"] = o.CutoffDay.Get()
	}
	if o.FixedDay.IsSet() {
		toSerialize["fixed_day"] = o.FixedDay.Get()
	}
	return json.Marshal(toSerialize)
}

type NullablePartnerResponsePartnerPaymentTermAttributes struct {
	value *PartnerResponsePartnerPaymentTermAttributes
	isSet bool
}

func (v NullablePartnerResponsePartnerPaymentTermAttributes) Get() *PartnerResponsePartnerPaymentTermAttributes {
	return v.value
}

func (v *NullablePartnerResponsePartnerPaymentTermAttributes) Set(val *PartnerResponsePartnerPaymentTermAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerResponsePartnerPaymentTermAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerResponsePartnerPaymentTermAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerResponsePartnerPaymentTermAttributes(val *PartnerResponsePartnerPaymentTermAttributes) *NullablePartnerResponsePartnerPaymentTermAttributes {
	return &NullablePartnerResponsePartnerPaymentTermAttributes{value: val, isSet: true}
}

func (v NullablePartnerResponsePartnerPaymentTermAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerResponsePartnerPaymentTermAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
