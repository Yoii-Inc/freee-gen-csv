...
type InvoiceUpdateParams struct {
	...
	// 請求内容
	InvoiceContents []InvoiceUpdateParamsInvoiceContentsInner `json:"invoice_contents,omitempty"`
...
func (o *InvoiceUpdateParams) GetInvoiceContents() []InvoiceUpdateParamsInvoiceContentsInner {
	if o == nil || o.InvoiceContents == nil {
		var ret []InvoiceUpdateParamsInvoiceContentsInner
		return ret
	}
...
// SetInvoiceContents gets a reference to the given []InvoiceUpdateParamsInvoiceContentsInner and assigns it to the InvoiceContents field.
