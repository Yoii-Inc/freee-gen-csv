...
// TrialCrThreeYearsResponse struct for TrialCrThreeYearsResponse
type TrialCrThreeYearsResponse struct {
	TrialCrThreeYears TrialCrThreeYearsResponseTrialCrThreeYears `json:"trial_cr_three_years"`
	// 集計結果が最新かどうか
...
func NewTrialCrThreeYearsResponse(trialCrThreeYears TrialCrThreeYearsResponseTrialCrThreeYears, upToDate bool) *TrialCrThreeYearsResponse {
	this := TrialCrThreeYearsResponse{}
...
func (o TrialCrThreeYearsResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["trial_cr_three_years"] = o.TrialCrThreeYears
	}
	if true {
...
type NullableTrialCrThreeYearsResponse struct {
	value *TrialCrThreeYearsResponse
	isSet bool
}

func (v NullableTrialCrThreeYearsResponse) Get() *TrialCrThreeYearsResponse {
	return v.value
}

func (v *NullableTrialCrThreeYearsResponse) Set(val *TrialCrThreeYearsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrThreeYearsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrThreeYearsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrThreeYearsResponse(val *TrialCrThreeYearsResponse) *NullableTrialCrThreeYearsResponse {
	return &NullableTrialCrThreeYearsResponse{value: val, isSet: true}
}

func (v NullableTrialCrThreeYearsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrThreeYearsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
