...
type DealCreateParams struct {
	...
	Details []DealCreateParamsDetailsInner `json:"details"`
	// 支払期日(yyyy-mm-dd)
	...
	Payments []DealCreateParamsPaymentsInner `json:"payments,omitempty"`
...
func (o *DealCreateParams) GetDetails() []DealCreateParamsDetailsInner {
	if o == nil {
		var ret []DealCreateParamsDetailsInner
		return ret
	}
...
func (o *DealCreateParams) GetPayments() []DealCreateParamsPaymentsInner {
	if o == nil || o.Payments == nil {
		var ret []DealCreateParamsPaymentsInner
		return ret
	}
	return o.Payments
}
...
// SetPayments gets a reference to the given []DealCreateParamsPaymentsInner and assigns it to the Payments field.
