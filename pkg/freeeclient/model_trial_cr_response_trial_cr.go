...
// TrialCrResponseTrialCr struct for TrialCrResponseTrialCr
type TrialCrResponseTrialCr struct {
	...
	Balances []TrialBsResponseTrialBsBalancesInner `json:"balances"`
...
func (o *TrialCrResponseTrialCr) GetBalances() []TrialBsResponseTrialBsBalancesInner {
	if o == nil {
		var ret []TrialBsResponseTrialBsBalancesInner
		return ret
	}
...
func (o TrialCrResponseTrialCr) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrResponseTrialCr struct {
	value *TrialCrResponseTrialCr
	isSet bool
}

func (v NullableTrialCrResponseTrialCr) Get() *TrialCrResponseTrialCr {
	return v.value
}

func (v *NullableTrialCrResponseTrialCr) Set(val *TrialCrResponseTrialCr) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrResponseTrialCr) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrResponseTrialCr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrResponseTrialCr(val *TrialCrResponseTrialCr) *NullableTrialCrResponseTrialCr {
	return &NullableTrialCrResponseTrialCr{value: val, isSet: true}
}

func (v NullableTrialCrResponseTrialCr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrResponseTrialCr) UnmarshalJSON(src []byte) error {
	v.isSet = true
