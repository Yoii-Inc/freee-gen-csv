...
func (o Walletable) MarshalJSON() ([]byte, error) {
...
type NullableWalletable struct {
	value *Walletable
	isSet bool
}

func (v NullableWalletable) Get() *Walletable {
	return v.value
}

func (v *NullableWalletable) Set(val *Walletable) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletable) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletable(val *Walletable) *NullableWalletable {
	return &NullableWalletable{value: val, isSet: true}
}

func (v NullableWalletable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletable) UnmarshalJSON(src []byte) error {
	v.isSet = true
