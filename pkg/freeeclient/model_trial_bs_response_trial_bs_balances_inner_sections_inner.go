...
// TrialBsResponseTrialBsBalancesInnerSectionsInner struct for TrialBsResponseTrialBsBalancesInnerSectionsInner
type TrialBsResponseTrialBsBalancesInnerSectionsInner struct {
	// 期末残高
...
func NewTrialBsResponseTrialBsBalancesInnerSectionsInner(id int32) *TrialBsResponseTrialBsBalancesInnerSectionsInner {
	this := TrialBsResponseTrialBsBalancesInnerSectionsInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsResponseTrialBsBalancesInnerSectionsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsResponseTrialBsBalancesInnerSectionsInner struct {
	value *TrialBsResponseTrialBsBalancesInnerSectionsInner
	isSet bool
}

func (v NullableTrialBsResponseTrialBsBalancesInnerSectionsInner) Get() *TrialBsResponseTrialBsBalancesInnerSectionsInner {
	return v.value
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerSectionsInner) Set(val *TrialBsResponseTrialBsBalancesInnerSectionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsResponseTrialBsBalancesInnerSectionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerSectionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsResponseTrialBsBalancesInnerSectionsInner(val *TrialBsResponseTrialBsBalancesInnerSectionsInner) *NullableTrialBsResponseTrialBsBalancesInnerSectionsInner {
	return &NullableTrialBsResponseTrialBsBalancesInnerSectionsInner{value: val, isSet: true}
}

func (v NullableTrialBsResponseTrialBsBalancesInnerSectionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerSectionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
