...
type QuotationUpdateParams struct {
	...
	// 見積内容
	QuotationContents []QuotationUpdateParamsQuotationContentsInner `json:"quotation_contents,omitempty"`
...
func (o *QuotationUpdateParams) GetQuotationContents() []QuotationUpdateParamsQuotationContentsInner {
	if o == nil || o.QuotationContents == nil {
		var ret []QuotationUpdateParamsQuotationContentsInner
		return ret
	}
...
// SetQuotationContents gets a reference to the given []QuotationUpdateParamsQuotationContentsInner and assigns it to the QuotationContents field.
