...
// CompanyIndexResponseCompaniesInner struct for CompanyIndexResponseCompaniesInner
type CompanyIndexResponseCompaniesInner struct {
	// 事業所名
...
func (o CompanyIndexResponseCompaniesInner) MarshalJSON() ([]byte, error) {
...
type NullableCompanyIndexResponseCompaniesInner struct {
	value *CompanyIndexResponseCompaniesInner
	isSet bool
}

func (v NullableCompanyIndexResponseCompaniesInner) Get() *CompanyIndexResponseCompaniesInner {
	return v.value
}

func (v *NullableCompanyIndexResponseCompaniesInner) Set(val *CompanyIndexResponseCompaniesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyIndexResponseCompaniesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyIndexResponseCompaniesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyIndexResponseCompaniesInner(val *CompanyIndexResponseCompaniesInner) *NullableCompanyIndexResponseCompaniesInner {
	return &NullableCompanyIndexResponseCompaniesInner{value: val, isSet: true}
}

func (v NullableCompanyIndexResponseCompaniesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyIndexResponseCompaniesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
