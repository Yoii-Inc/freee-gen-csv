...
type PartnersResponsePartners struct {
	...
	AddressAttributesPrefectureCode NullableInt32 `json:"address_attributes[prefecture_code],omitempty"`
	// 市区町村・番地
...
// GetAddressAttributesPrefectureCode returns the AddressAttributesPrefectureCode field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PartnersResponsePartners) GetAddressAttributesPrefectureCode() int32 {
	if o == nil || o.AddressAttributesPrefectureCode.Get() == nil {
		var ret int32
		return ret
	}
	return *o.AddressAttributesPrefectureCode.Get()
}
...
func (o *PartnersResponsePartners) GetAddressAttributesPrefectureCodeOk() (*int32, bool) {
	...
	return o.AddressAttributesPrefectureCode.Get(), o.AddressAttributesPrefectureCode.IsSet()
}
...
func (o *PartnersResponsePartners) HasAddressAttributesPrefectureCode() bool {
	if o != nil && o.AddressAttributesPrefectureCode.IsSet() {
		return true
	}
...
// SetAddressAttributesPrefectureCode gets a reference to the given NullableInt32 and assigns it to the AddressAttributesPrefectureCode field.
func (o *PartnersResponsePartners) SetAddressAttributesPrefectureCode(v int32) {
	o.AddressAttributesPrefectureCode.Set(&v)
}
// SetAddressAttributesPrefectureCodeNil sets the value for AddressAttributesPrefectureCode to be an explicit nil
func (o *PartnersResponsePartners) SetAddressAttributesPrefectureCodeNil() {
	o.AddressAttributesPrefectureCode.Set(nil)
}
...
func (o *PartnersResponsePartners) UnsetAddressAttributesPrefectureCode() {
	o.AddressAttributesPrefectureCode.Unset()
}
...
func (o PartnersResponsePartners) MarshalJSON() ([]byte, error) {
	...
	if o.AddressAttributesPrefectureCode.IsSet() {
		toSerialize["address_attributes[prefecture_code]"] = o.AddressAttributesPrefectureCode.Get()
	}
