...
// TrialCrSectionsResponseTrialCrSections struct for TrialCrSectionsResponseTrialCrSections
type TrialCrSectionsResponseTrialCrSections struct {
	...
	Balances []TrialCrSectionsResponseTrialCrSectionsBalancesInner `json:"balances"`
...
func NewTrialCrSectionsResponseTrialCrSections(balances []TrialCrSectionsResponseTrialCrSectionsBalancesInner, companyId int32, sectionIds string) *TrialCrSectionsResponseTrialCrSections {
	this := TrialCrSectionsResponseTrialCrSections{}
...
func (o *TrialCrSectionsResponseTrialCrSections) GetBalances() []TrialCrSectionsResponseTrialCrSectionsBalancesInner {
	if o == nil {
		var ret []TrialCrSectionsResponseTrialCrSectionsBalancesInner
		return ret
	}
...
func (o TrialCrSectionsResponseTrialCrSections) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrSectionsResponseTrialCrSections struct {
	value *TrialCrSectionsResponseTrialCrSections
	isSet bool
}

func (v NullableTrialCrSectionsResponseTrialCrSections) Get() *TrialCrSectionsResponseTrialCrSections {
	return v.value
}

func (v *NullableTrialCrSectionsResponseTrialCrSections) Set(val *TrialCrSectionsResponseTrialCrSections) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSectionsResponseTrialCrSections) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSectionsResponseTrialCrSections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSectionsResponseTrialCrSections(val *TrialCrSectionsResponseTrialCrSections) *NullableTrialCrSectionsResponseTrialCrSections {
	return &NullableTrialCrSectionsResponseTrialCrSections{value: val, isSet: true}
}

func (v NullableTrialCrSectionsResponseTrialCrSections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSectionsResponseTrialCrSections) UnmarshalJSON(src []byte) error {
	v.isSet = true
