...
// DealCreateParamsDetailsInner struct for DealCreateParamsDetailsInner
type DealCreateParamsDetailsInner struct {
	// 勘定科目ID
...
func NewDealCreateParamsDetailsInner(accountItemId int64, amount int64, taxCode int64) *DealCreateParamsDetailsInner {
	this := DealCreateParamsDetailsInner{}
...
func (o DealCreateParamsDetailsInner) MarshalJSON() ([]byte, error) {
...
type NullableDealCreateParamsDetailsInner struct {
	value *DealCreateParamsDetailsInner
	isSet bool
}

func (v NullableDealCreateParamsDetailsInner) Get() *DealCreateParamsDetailsInner {
	return v.value
}

func (v *NullableDealCreateParamsDetailsInner) Set(val *DealCreateParamsDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDealCreateParamsDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDealCreateParamsDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealCreateParamsDetailsInner(val *DealCreateParamsDetailsInner) *NullableDealCreateParamsDetailsInner {
	return &NullableDealCreateParamsDetailsInner{value: val, isSet: true}
}

func (v NullableDealCreateParamsDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealCreateParamsDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
