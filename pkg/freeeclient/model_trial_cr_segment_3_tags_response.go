...
// TrialCrSegment3TagsResponse struct for TrialCrSegment3TagsResponse
type TrialCrSegment3TagsResponse struct {
	TrialCrSegment3Tags TrialCrSegment3TagsResponseTrialCrSegment3Tags `json:"trial_cr_segment_3_tags"`
	// 集計結果が最新かどうか
...
func NewTrialCrSegment3TagsResponse(trialCrSegment3Tags TrialCrSegment3TagsResponseTrialCrSegment3Tags, upToDate bool) *TrialCrSegment3TagsResponse {
	this := TrialCrSegment3TagsResponse{}
...
// GetTrialCrSegment3Tags returns the TrialCrSegment3Tags field value
...
func (o TrialCrSegment3TagsResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["trial_cr_segment_3_tags"] = o.TrialCrSegment3Tags
	}
	if true {
...
type NullableTrialCrSegment3TagsResponse struct {
	value *TrialCrSegment3TagsResponse
	isSet bool
}

func (v NullableTrialCrSegment3TagsResponse) Get() *TrialCrSegment3TagsResponse {
	return v.value
}

func (v *NullableTrialCrSegment3TagsResponse) Set(val *TrialCrSegment3TagsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSegment3TagsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSegment3TagsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSegment3TagsResponse(val *TrialCrSegment3TagsResponse) *NullableTrialCrSegment3TagsResponse {
	return &NullableTrialCrSegment3TagsResponse{value: val, isSet: true}
}

func (v NullableTrialCrSegment3TagsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSegment3TagsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
