...
// ManualJournalDetailsInner struct for ManualJournalDetailsInner
type ManualJournalDetailsInner struct {
	// 勘定科目ID
...
func NewManualJournalDetailsInner(accountItemId int32, amount int32, description string, entrySide string, id int64, itemId NullableInt32, itemName NullableString, partnerId NullableInt32, partnerLongName NullableString, partnerName NullableString, sectionId NullableInt32, sectionName NullableString, tagIds []int32, tagNames []string, taxCode int32, vat int32) *ManualJournalDetailsInner {
	this := ManualJournalDetailsInner{}
...
func (o *ManualJournalDetailsInner) SetPartnerCodeNil() {
...
func (o ManualJournalDetailsInner) MarshalJSON() ([]byte, error) {
...
type NullableManualJournalDetailsInner struct {
	value *ManualJournalDetailsInner
	isSet bool
}

func (v NullableManualJournalDetailsInner) Get() *ManualJournalDetailsInner {
	return v.value
}

func (v *NullableManualJournalDetailsInner) Set(val *ManualJournalDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableManualJournalDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableManualJournalDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualJournalDetailsInner(val *ManualJournalDetailsInner) *NullableManualJournalDetailsInner {
	return &NullableManualJournalDetailsInner{value: val, isSet: true}
}

func (v NullableManualJournalDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualJournalDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
