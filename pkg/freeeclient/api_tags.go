...
func (r ApiGetTagsRequest) Execute() (InlineResponse2008, *_nethttp.Response, error) {
 ...
 */
func (a *TagsApiService) GetTagsExecute(r ApiGetTagsRequest) (InlineResponse2008, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
