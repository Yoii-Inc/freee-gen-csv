...
func (r ApiGetCompaniesRequest) Execute() (*CompanyIndexResponse, *http.Response, error) {
...
func (a *CompaniesApiService) GetCompaniesExecute(r ApiGetCompaniesRequest) (*CompanyIndexResponse, *http.Response, error) {
	var (
