...
// TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner struct for TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner
type TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner struct {
	// 期末残高
...
func NewTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner(id int64) *TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner {
	this := TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner{}
	this.Id = id
	return &this
}
...
func (o TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner struct {
	value *TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner
	isSet bool
}

func (v NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) Get() *TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner {
	return v.value
}

func (v *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) Set(val *TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner(val *TrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner {
	return &NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner{value: val, isSet: true}
}

func (v NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSectionsResponseTrialCrSectionsBalancesInnerSectionsInnerSegment2TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
