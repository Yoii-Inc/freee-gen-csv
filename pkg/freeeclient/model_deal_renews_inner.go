...
// DealRenewsInner struct for DealRenewsInner
type DealRenewsInner struct {
	// +更新の明細行一覧（配列）
	Details []DealRenewsInnerDetailsInner `json:"details"`
	// +更新行ID
	Id int64 `json:"id"`
	// +更新の対象行ID
...
func (o *DealRenewsInner) GetDetails() []DealRenewsInnerDetailsInner {
	if o == nil {
		var ret []DealRenewsInnerDetailsInner
		return ret
	}
...
func (o DealRenewsInner) MarshalJSON() ([]byte, error) {
...
type NullableDealRenewsInner struct {
	value *DealRenewsInner
	isSet bool
}

func (v NullableDealRenewsInner) Get() *DealRenewsInner {
	return v.value
}

func (v *NullableDealRenewsInner) Set(val *DealRenewsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDealRenewsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDealRenewsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealRenewsInner(val *DealRenewsInner) *NullableDealRenewsInner {
	return &NullableDealRenewsInner{value: val, isSet: true}
}

func (v NullableDealRenewsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealRenewsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
