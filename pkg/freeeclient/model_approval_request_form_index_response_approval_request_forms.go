...
// ApprovalRequestFormIndexResponseApprovalRequestForms struct for ApprovalRequestFormIndexResponseApprovalRequestForms
type ApprovalRequestFormIndexResponseApprovalRequestForms struct {
	// 事業所ID
...
func NewApprovalRequestFormIndexResponseApprovalRequestForms(companyId int32, createdDate string, description string, formOrder NullableInt32, id int32, name string, routeSettingCount int32, status string) *ApprovalRequestFormIndexResponseApprovalRequestForms {
	this := ApprovalRequestFormIndexResponseApprovalRequestForms{}
...
func (o ApprovalRequestFormIndexResponseApprovalRequestForms) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestFormIndexResponseApprovalRequestForms struct {
	value *ApprovalRequestFormIndexResponseApprovalRequestForms
	isSet bool
}

func (v NullableApprovalRequestFormIndexResponseApprovalRequestForms) Get() *ApprovalRequestFormIndexResponseApprovalRequestForms {
	return v.value
}

func (v *NullableApprovalRequestFormIndexResponseApprovalRequestForms) Set(val *ApprovalRequestFormIndexResponseApprovalRequestForms) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestFormIndexResponseApprovalRequestForms) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestFormIndexResponseApprovalRequestForms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestFormIndexResponseApprovalRequestForms(val *ApprovalRequestFormIndexResponseApprovalRequestForms) *NullableApprovalRequestFormIndexResponseApprovalRequestForms {
	return &NullableApprovalRequestFormIndexResponseApprovalRequestForms{value: val, isSet: true}
}

func (v NullableApprovalRequestFormIndexResponseApprovalRequestForms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestFormIndexResponseApprovalRequestForms) UnmarshalJSON(src []byte) error {
	v.isSet = true
