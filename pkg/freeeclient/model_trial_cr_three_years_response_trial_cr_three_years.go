...
// TrialCrThreeYearsResponseTrialCrThreeYears struct for TrialCrThreeYearsResponseTrialCrThreeYears
type TrialCrThreeYearsResponseTrialCrThreeYears struct {
...
func NewTrialCrThreeYearsResponseTrialCrThreeYears(balances []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner, companyId int32) *TrialCrThreeYearsResponseTrialCrThreeYears {
	this := TrialCrThreeYearsResponseTrialCrThreeYears{}
...
func (o TrialCrThreeYearsResponseTrialCrThreeYears) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrThreeYearsResponseTrialCrThreeYears struct {
	value *TrialCrThreeYearsResponseTrialCrThreeYears
	isSet bool
}

func (v NullableTrialCrThreeYearsResponseTrialCrThreeYears) Get() *TrialCrThreeYearsResponseTrialCrThreeYears {
	return v.value
}

func (v *NullableTrialCrThreeYearsResponseTrialCrThreeYears) Set(val *TrialCrThreeYearsResponseTrialCrThreeYears) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrThreeYearsResponseTrialCrThreeYears) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrThreeYearsResponseTrialCrThreeYears) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrThreeYearsResponseTrialCrThreeYears(val *TrialCrThreeYearsResponseTrialCrThreeYears) *NullableTrialCrThreeYearsResponseTrialCrThreeYears {
	return &NullableTrialCrThreeYearsResponseTrialCrThreeYears{value: val, isSet: true}
}

func (v NullableTrialCrThreeYearsResponseTrialCrThreeYears) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrThreeYearsResponseTrialCrThreeYears) UnmarshalJSON(src []byte) error {
	v.isSet = true
