...
// TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner struct for TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner
type TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner struct {
	// 期末残高
...
func NewTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner(id int64) *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
	this := TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner struct {
	value *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner
	isSet bool
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) Get() *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
	return v.value
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) Set(val *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner(val *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
	return &NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner{value: val, isSet: true}
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
