...
// TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner struct for TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner
type TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner struct {
	// 期末残高
...
func NewTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner(id int32) *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner {
	this := TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner struct {
	value *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner
	isSet bool
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) Get() *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner {
	return v.value
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) Set(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner {
	return &NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner{value: val, isSet: true}
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSegment3TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
