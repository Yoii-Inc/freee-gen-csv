...
// TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner struct for TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner
type TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner struct {
	// 勘定科目カテゴリー名
	...
	Items []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner `json:"items,omitempty"`
	// 前年度期末残高
	...
	Partners []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner `json:"partners,omitempty"`
	// breakdown_display_type:section, account_item_display_type:account_item指定時のみ含まれる
	Sections []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner `json:"sections,omitempty"`
	// breakdown_display_type:segment_1_tag, account_item_display_type:account_item指定時のみ含まれる
	Segment1Tags []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner `json:"segment_1_tags,omitempty"`
	// breakdown_display_type:segment_2_tag, account_item_display_type:account_item指定時のみ含まれる
	Segment2Tags []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner `json:"segment_2_tags,omitempty"`
	// breakdown_display_type:segment_3_tag, account_item_display_type:account_item指定時のみ含まれる
	Segment3Tags []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment3TagsInner `json:"segment_3_tags,omitempty"`
...
func NewTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner() *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner {
	this := TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner{}
	return &this
}
...
func (o *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) GetItems() []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner {
	if o == nil || o.Items == nil {
		var ret []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerItemsInner and assigns it to the Items field.
...
func (o *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) GetPartners() []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner {
	if o == nil || o.Partners == nil {
		var ret []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner
		return ret
	}
	return o.Partners
}
...
// SetPartners gets a reference to the given []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerPartnersInner and assigns it to the Partners field.
...
func (o *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) GetSections() []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner {
	if o == nil || o.Sections == nil {
		var ret []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner
		return ret
	}
	return o.Sections
}
...
// SetSections gets a reference to the given []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSectionsInner and assigns it to the Sections field.
...
func (o *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) GetSegment1Tags() []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner {
	if o == nil || o.Segment1Tags == nil {
		var ret []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner
		return ret
	}
...
// SetSegment1Tags gets a reference to the given []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment1TagsInner and assigns it to the Segment1Tags field.
...
func (o *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) GetSegment2Tags() []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner {
	if o == nil || o.Segment2Tags == nil {
		var ret []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner
		return ret
	}
...
// SetSegment2Tags gets a reference to the given []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment2TagsInner and assigns it to the Segment2Tags field.
...
func (o *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) GetSegment3Tags() []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment3TagsInner {
	if o == nil || o.Segment3Tags == nil {
		var ret []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment3TagsInner
		return ret
	}
...
// SetSegment3Tags gets a reference to the given []TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInnerSegment3TagsInner and assigns it to the Segment3Tags field.
...
func (o TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner struct {
	value *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner
	isSet bool
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) Get() *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner {
	return v.value
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) Set(val *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner(val *TrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner {
	return &NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner{value: val, isSet: true}
}

func (v NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsThreeYearsResponseTrialBsThreeYearsBalancesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
