...
type ManualJournalCreateParamsDetailsInner struct {
	// 勘定科目ID
...
func NewManualJournalCreateParamsDetailsInner(accountItemId int32, amount int64, entrySide string, taxCode int32) *ManualJournalCreateParamsDetailsInner {
	this := ManualJournalCreateParamsDetailsInner{}
...
func (o ManualJournalCreateParamsDetailsInner) MarshalJSON() ([]byte, error) {
...
type NullableManualJournalCreateParamsDetailsInner struct {
	value *ManualJournalCreateParamsDetailsInner
	isSet bool
}

func (v NullableManualJournalCreateParamsDetailsInner) Get() *ManualJournalCreateParamsDetailsInner {
	return v.value
}

func (v *NullableManualJournalCreateParamsDetailsInner) Set(val *ManualJournalCreateParamsDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableManualJournalCreateParamsDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableManualJournalCreateParamsDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualJournalCreateParamsDetailsInner(val *ManualJournalCreateParamsDetailsInner) *NullableManualJournalCreateParamsDetailsInner {
	return &NullableManualJournalCreateParamsDetailsInner{value: val, isSet: true}
}

func (v NullableManualJournalCreateParamsDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualJournalCreateParamsDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
