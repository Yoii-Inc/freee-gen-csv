...
// TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner struct for TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner
type TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner struct {
	// 期末残高
...
func NewTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner(id int32) *TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner {
	this := TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner{}
	this.Id = id
	return &this
}
...
func (o TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner struct {
	value *TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner
	isSet bool
}

func (v NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) Get() *TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner {
	return v.value
}

func (v *NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) Set(val *TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner(val *TrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) *NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner {
	return &NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner{value: val, isSet: true}
}

func (v NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSegment1TagsResponseTrialCrSegment1TagsBalancesInnerSegment1TagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
