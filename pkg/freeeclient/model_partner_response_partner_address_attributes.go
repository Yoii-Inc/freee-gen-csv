...
type PartnerResponsePartnerAddressAttributes struct {
	...
	PrefectureCodes NullableInt32 `json:"prefecture_codes,omitempty"`
	// 市区町村・番地
...
// SetPrefectureCodes gets a reference to the given NullableInt32 and assigns it to the PrefectureCodes field.
