...
//  @return BankResponse
func (a *BanksApiService) GetBankExecute(r ApiGetBankRequest) (*BankResponse, *http.Response, error) {
	var (
...
func (r ApiGetBanksRequest) Offset(offset int64) ApiGetBanksRequest {
	r.offset = &offset
	return r
}
...
*/
func (a *BanksApiService) GetBanks(ctx context.Context) ApiGetBanksRequest {
	return ApiGetBanksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *BanksApiService) GetBanksExecute(r ApiGetBanksRequest) (*GetBanks200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
