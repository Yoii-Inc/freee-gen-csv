...
// CompanyResponseCompanyItemsInner struct for CompanyResponseCompanyItemsInner
type CompanyResponseCompanyItemsInner struct {
	// 品目ID
	Id int32 `json:"id"`
	// 品目名 (30文字以内)
...
func NewCompanyResponseCompanyItemsInner(id int32, name string) *CompanyResponseCompanyItemsInner {
	this := CompanyResponseCompanyItemsInner{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *CompanyResponseCompanyItemsInner) SetShortcut1Nil() {
	o.Shortcut1.Set(nil)
}
...
func (o *CompanyResponseCompanyItemsInner) SetShortcut2Nil() {
	o.Shortcut2.Set(nil)
}
...
func (o CompanyResponseCompanyItemsInner) MarshalJSON() ([]byte, error) {
...
type NullableCompanyResponseCompanyItemsInner struct {
	value *CompanyResponseCompanyItemsInner
	isSet bool
}

func (v NullableCompanyResponseCompanyItemsInner) Get() *CompanyResponseCompanyItemsInner {
	return v.value
}

func (v *NullableCompanyResponseCompanyItemsInner) Set(val *CompanyResponseCompanyItemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyResponseCompanyItemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyResponseCompanyItemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyResponseCompanyItemsInner(val *CompanyResponseCompanyItemsInner) *NullableCompanyResponseCompanyItemsInner {
	return &NullableCompanyResponseCompanyItemsInner{value: val, isSet: true}
}

func (v NullableCompanyResponseCompanyItemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyResponseCompanyItemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
