...
type MeResponseUser struct {
	Companies []MeResponseUserCompaniesInner `json:"companies,omitempty"`
	// 表示ユーザー名
...
func (o *MeResponseUser) GetCompanies() []MeResponseUserCompaniesInner {
	if o == nil || o.Companies == nil {
		var ret []MeResponseUserCompaniesInner
		return ret
	}
	return o.Companies
}
...
// SetCompanies gets a reference to the given []MeResponseUserCompaniesInner and assigns it to the Companies field.
