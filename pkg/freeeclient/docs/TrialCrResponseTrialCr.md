...
### NewTrialCrResponseTrialCr

`func NewTrialCrResponseTrialCr(balances []TrialBsResponseTrialBsBalancesInner, companyId int32, ) *TrialCrResponseTrialCr`

NewTrialCrResponseTrialCr instantiates a new TrialCrResponseTrialCr object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewTrialCrResponseTrialCrWithDefaults

`func NewTrialCrResponseTrialCrWithDefaults() *TrialCrResponseTrialCr`

NewTrialCrResponseTrialCrWithDefaults instantiates a new TrialCrResponseTrialCr object
...
`func (o *TrialCrResponseTrialCr) SetBreakdownDisplayType(v string)`
...
`func (o *TrialCrResponseTrialCr) GetCompanyId() int32`

GetCompanyId returns the CompanyId field if non-nil, zero value otherwise.

### GetCompanyIdOk

`func (o *TrialCrResponseTrialCr) GetCompanyIdOk() (*int32, bool)`
...
`func (o *TrialCrResponseTrialCr) SetCompanyId(v int32)`
...
`func (o *TrialCrResponseTrialCr) GetCreatedAt() string`
...
`func (o *TrialCrResponseTrialCr) GetEndMonth() int32`

GetEndMonth returns the EndMonth field if non-nil, zero value otherwise.

### GetEndMonthOk

`func (o *TrialCrResponseTrialCr) GetEndMonthOk() (*int32, bool)`
...
`func (o *TrialCrResponseTrialCr) SetEndMonth(v int32)`
...
`func (o *TrialCrResponseTrialCr) GetFiscalYear() int32`

GetFiscalYear returns the FiscalYear field if non-nil, zero value otherwise.

### GetFiscalYearOk

`func (o *TrialCrResponseTrialCr) GetFiscalYearOk() (*int32, bool)`
...
`func (o *TrialCrResponseTrialCr) SetFiscalYear(v int32)`
...
`func (o *TrialCrResponseTrialCr) GetItemId() int32`

GetItemId returns the ItemId field if non-nil, zero value otherwise.

### GetItemIdOk

`func (o *TrialCrResponseTrialCr) GetItemIdOk() (*int32, bool)`
...
`func (o *TrialCrResponseTrialCr) SetItemId(v int32)`
...
`func (o *TrialCrResponseTrialCr) GetPartnerId() int32`

GetPartnerId returns the PartnerId field if non-nil, zero value otherwise.

### GetPartnerIdOk

`func (o *TrialCrResponseTrialCr) GetPartnerIdOk() (*int32, bool)`
...
`func (o *TrialCrResponseTrialCr) SetPartnerId(v int32)`
...
`func (o *TrialCrResponseTrialCr) GetSectionId() int32`

GetSectionId returns the SectionId field if non-nil, zero value otherwise.

### GetSectionIdOk

`func (o *TrialCrResponseTrialCr) GetSectionIdOk() (*int32, bool)`
...
`func (o *TrialCrResponseTrialCr) SetSectionId(v int32)`
...
`func (o *TrialCrResponseTrialCr) GetStartMonth() int32`

GetStartMonth returns the StartMonth field if non-nil, zero value otherwise.

### GetStartMonthOk

`func (o *TrialCrResponseTrialCr) GetStartMonthOk() (*int32, bool)`
...
`func (o *TrialCrResponseTrialCr) SetStartMonth(v int32)`
