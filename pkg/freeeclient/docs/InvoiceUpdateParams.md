...
**CompanyContactInfo** | Pointer to **string** | 事業所担当者名 (デフォルトは請求書テンプレート情報が補完されます) | [optional] 
...
**InvoiceContents** | Pointer to [**[]InvoiceUpdateParamsInvoiceContentsInner**](InvoiceUpdateParamsInvoiceContentsInner.md) | 請求内容 | [optional] 
