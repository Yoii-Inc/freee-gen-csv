...
func (o *QuotationUpdateParamsQuotationContentsInner) SetVatNil() {
	o.Vat.Set(nil)
}
...
func (o QuotationUpdateParamsQuotationContentsInner) MarshalJSON() ([]byte, error) {
...
type NullableQuotationUpdateParamsQuotationContentsInner struct {
	value *QuotationUpdateParamsQuotationContentsInner
	isSet bool
}

func (v NullableQuotationUpdateParamsQuotationContentsInner) Get() *QuotationUpdateParamsQuotationContentsInner {
	return v.value
}

func (v *NullableQuotationUpdateParamsQuotationContentsInner) Set(val *QuotationUpdateParamsQuotationContentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQuotationUpdateParamsQuotationContentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQuotationUpdateParamsQuotationContentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuotationUpdateParamsQuotationContentsInner(val *QuotationUpdateParamsQuotationContentsInner) *NullableQuotationUpdateParamsQuotationContentsInner {
	return &NullableQuotationUpdateParamsQuotationContentsInner{value: val, isSet: true}
}

func (v NullableQuotationUpdateParamsQuotationContentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuotationUpdateParamsQuotationContentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
