...
type ApprovalRequestFormResponseApprovalRequestForm struct {
	...
	// 申請フォームの項目
	Parts []ApprovalRequestFormResponseApprovalRequestFormPartsInner `json:"parts,omitempty"`
	// 適用された経路数
...
func (o *ApprovalRequestFormResponseApprovalRequestForm) GetParts() []ApprovalRequestFormResponseApprovalRequestFormPartsInner {
	if o == nil || o.Parts == nil {
		var ret []ApprovalRequestFormResponseApprovalRequestFormPartsInner
		return ret
	}
	return o.Parts
}
...
// SetParts gets a reference to the given []ApprovalRequestFormResponseApprovalRequestFormPartsInner and assigns it to the Parts field.
