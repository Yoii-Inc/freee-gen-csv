...
// TrialCrSectionsResponse struct for TrialCrSectionsResponse
type TrialCrSectionsResponse struct {
	TrialCrSections TrialCrSectionsResponseTrialCrSections `json:"trial_cr_sections"`
	// 集計結果が最新かどうか
...
// GetTrialCrSections returns the TrialCrSections field value
func (o *TrialCrSectionsResponse) GetTrialCrSections() TrialCrSectionsResponseTrialCrSections {
	if o == nil {
		var ret TrialCrSectionsResponseTrialCrSections
		return ret
	}

	return o.TrialCrSections
}

// GetTrialCrSectionsOk returns a tuple with the TrialCrSections field value
// and a boolean to check if the value has been set.
func (o *TrialCrSectionsResponse) GetTrialCrSectionsOk() (*TrialCrSectionsResponseTrialCrSections, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TrialCrSections, true
}

// SetTrialCrSections sets field value
...
func (o TrialCrSectionsResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["trial_cr_sections"] = o.TrialCrSections
	}
	if true {
...
type NullableTrialCrSectionsResponse struct {
	value *TrialCrSectionsResponse
	isSet bool
}

func (v NullableTrialCrSectionsResponse) Get() *TrialCrSectionsResponse {
	return v.value
}

func (v *NullableTrialCrSectionsResponse) Set(val *TrialCrSectionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSectionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSectionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSectionsResponse(val *TrialCrSectionsResponse) *NullableTrialCrSectionsResponse {
	return &NullableTrialCrSectionsResponse{value: val, isSet: true}
}

func (v NullableTrialCrSectionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSectionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
