...
// TrialCrTwoYearsResponseTrialCrTwoYears struct for TrialCrTwoYearsResponseTrialCrTwoYears
type TrialCrTwoYearsResponseTrialCrTwoYears struct {
...
func NewTrialCrTwoYearsResponseTrialCrTwoYears(balances []TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInner, companyId int32) *TrialCrTwoYearsResponseTrialCrTwoYears {
	this := TrialCrTwoYearsResponseTrialCrTwoYears{}
...
func (o TrialCrTwoYearsResponseTrialCrTwoYears) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrTwoYearsResponseTrialCrTwoYears struct {
	value *TrialCrTwoYearsResponseTrialCrTwoYears
	isSet bool
}

func (v NullableTrialCrTwoYearsResponseTrialCrTwoYears) Get() *TrialCrTwoYearsResponseTrialCrTwoYears {
	return v.value
}

func (v *NullableTrialCrTwoYearsResponseTrialCrTwoYears) Set(val *TrialCrTwoYearsResponseTrialCrTwoYears) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrTwoYearsResponseTrialCrTwoYears) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrTwoYearsResponseTrialCrTwoYears) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrTwoYearsResponseTrialCrTwoYears(val *TrialCrTwoYearsResponseTrialCrTwoYears) *NullableTrialCrTwoYearsResponseTrialCrTwoYears {
	return &NullableTrialCrTwoYearsResponseTrialCrTwoYears{value: val, isSet: true}
}

func (v NullableTrialCrTwoYearsResponseTrialCrTwoYears) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrTwoYearsResponseTrialCrTwoYears) UnmarshalJSON(src []byte) error {
	v.isSet = true
