...
// TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner struct for TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner
type TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner struct {
	// 勘定科目カテゴリー名
	...
	// セグメント2タグ
	Segment2Tags []TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner `json:"segment_2_tags,omitempty"`
...
func NewTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner() *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner {
	this := TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner{}
	return &this
}
...
func (o *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) GetSegment2Tags() []TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner {
	if o == nil || o.Segment2Tags == nil {
		var ret []TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner
		return ret
	}
...
// SetSegment2Tags gets a reference to the given []TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInnerSegment2TagsInner and assigns it to the Segment2Tags field.
...
func (o TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner struct {
	value *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner
	isSet bool
}

func (v NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) Get() *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner {
	return v.value
}

func (v *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) Set(val *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner(val *TrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner {
	return &NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner{value: val, isSet: true}
}

func (v NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialCrSegment2TagsResponseTrialCrSegment2TagsBalancesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
