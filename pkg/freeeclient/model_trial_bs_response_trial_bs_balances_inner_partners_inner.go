...
// TrialBsResponseTrialBsBalancesInnerPartnersInner struct for TrialBsResponseTrialBsBalancesInnerPartnersInner
type TrialBsResponseTrialBsBalancesInnerPartnersInner struct {
	// 期末残高
...
func NewTrialBsResponseTrialBsBalancesInnerPartnersInner(id int64) *TrialBsResponseTrialBsBalancesInnerPartnersInner {
	this := TrialBsResponseTrialBsBalancesInnerPartnersInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsResponseTrialBsBalancesInnerPartnersInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsResponseTrialBsBalancesInnerPartnersInner struct {
	value *TrialBsResponseTrialBsBalancesInnerPartnersInner
	isSet bool
}

func (v NullableTrialBsResponseTrialBsBalancesInnerPartnersInner) Get() *TrialBsResponseTrialBsBalancesInnerPartnersInner {
	return v.value
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerPartnersInner) Set(val *TrialBsResponseTrialBsBalancesInnerPartnersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsResponseTrialBsBalancesInnerPartnersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerPartnersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsResponseTrialBsBalancesInnerPartnersInner(val *TrialBsResponseTrialBsBalancesInnerPartnersInner) *NullableTrialBsResponseTrialBsBalancesInnerPartnersInner {
	return &NullableTrialBsResponseTrialBsBalancesInnerPartnersInner{value: val, isSet: true}
}

func (v NullableTrialBsResponseTrialBsBalancesInnerPartnersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerPartnersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
