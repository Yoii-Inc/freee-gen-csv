...
// CompanyResponseCompanyAccountItemsInner struct for CompanyResponseCompanyAccountItemsInner
...
func (o *CompanyResponseCompanyAccountItemsInner) SetShortcutNil() {
	o.Shortcut.Set(nil)
}
...
func (o CompanyResponseCompanyAccountItemsInner) MarshalJSON() ([]byte, error) {
...
type NullableCompanyResponseCompanyAccountItemsInner struct {
	value *CompanyResponseCompanyAccountItemsInner
	isSet bool
}

func (v NullableCompanyResponseCompanyAccountItemsInner) Get() *CompanyResponseCompanyAccountItemsInner {
	return v.value
}

func (v *NullableCompanyResponseCompanyAccountItemsInner) Set(val *CompanyResponseCompanyAccountItemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyResponseCompanyAccountItemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyResponseCompanyAccountItemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyResponseCompanyAccountItemsInner(val *CompanyResponseCompanyAccountItemsInner) *NullableCompanyResponseCompanyAccountItemsInner {
	return &NullableCompanyResponseCompanyAccountItemsInner{value: val, isSet: true}
}

func (v NullableCompanyResponseCompanyAccountItemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyResponseCompanyAccountItemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
