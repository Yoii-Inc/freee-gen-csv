...
// InlineResponse20010Taxes struct for InlineResponse20010Taxes
type InlineResponse20010Taxes struct {
...
func (o InlineResponse20010Taxes) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20010Taxes struct {
	value *InlineResponse20010Taxes
	isSet bool
}

func (v NullableInlineResponse20010Taxes) Get() *InlineResponse20010Taxes {
	return v.value
}

func (v *NullableInlineResponse20010Taxes) Set(val *InlineResponse20010Taxes) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20010Taxes) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20010Taxes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20010Taxes(val *InlineResponse20010Taxes) *NullableInlineResponse20010Taxes {
	return &NullableInlineResponse20010Taxes{value: val, isSet: true}
}

func (v NullableInlineResponse20010Taxes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20010Taxes) UnmarshalJSON(src []byte) error {
	v.isSet = true
