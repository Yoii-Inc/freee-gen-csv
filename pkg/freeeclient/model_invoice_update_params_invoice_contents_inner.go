...
// InvoiceUpdateParamsInvoiceContentsInner struct for InvoiceUpdateParamsInvoiceContentsInner
type InvoiceUpdateParamsInvoiceContentsInner struct {
	// 勘定科目ID
...
func NewInvoiceUpdateParamsInvoiceContentsInner(order int32, type_ string) *InvoiceUpdateParamsInvoiceContentsInner {
	this := InvoiceUpdateParamsInvoiceContentsInner{}
	this.Order = order
	this.Type = type_
	return &this
}
...
func (o *InvoiceUpdateParamsInvoiceContentsInner) SetVatNil() {
	o.Vat.Set(nil)
}
...
func (o InvoiceUpdateParamsInvoiceContentsInner) MarshalJSON() ([]byte, error) {
...
type NullableInvoiceUpdateParamsInvoiceContentsInner struct {
	value *InvoiceUpdateParamsInvoiceContentsInner
	isSet bool
}

func (v NullableInvoiceUpdateParamsInvoiceContentsInner) Get() *InvoiceUpdateParamsInvoiceContentsInner {
	return v.value
}

func (v *NullableInvoiceUpdateParamsInvoiceContentsInner) Set(val *InvoiceUpdateParamsInvoiceContentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceUpdateParamsInvoiceContentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceUpdateParamsInvoiceContentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceUpdateParamsInvoiceContentsInner(val *InvoiceUpdateParamsInvoiceContentsInner) *NullableInvoiceUpdateParamsInvoiceContentsInner {
	return &NullableInvoiceUpdateParamsInvoiceContentsInner{value: val, isSet: true}
}

func (v NullableInvoiceUpdateParamsInvoiceContentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceUpdateParamsInvoiceContentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
