...
// TrialBsResponseTrialBsBalancesInnerItemsInner struct for TrialBsResponseTrialBsBalancesInnerItemsInner
type TrialBsResponseTrialBsBalancesInnerItemsInner struct {
	// 期末残高
...
func NewTrialBsResponseTrialBsBalancesInnerItemsInner(id int32) *TrialBsResponseTrialBsBalancesInnerItemsInner {
	this := TrialBsResponseTrialBsBalancesInnerItemsInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsResponseTrialBsBalancesInnerItemsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsResponseTrialBsBalancesInnerItemsInner struct {
	value *TrialBsResponseTrialBsBalancesInnerItemsInner
	isSet bool
}

func (v NullableTrialBsResponseTrialBsBalancesInnerItemsInner) Get() *TrialBsResponseTrialBsBalancesInnerItemsInner {
	return v.value
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerItemsInner) Set(val *TrialBsResponseTrialBsBalancesInnerItemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsResponseTrialBsBalancesInnerItemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerItemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsResponseTrialBsBalancesInnerItemsInner(val *TrialBsResponseTrialBsBalancesInnerItemsInner) *NullableTrialBsResponseTrialBsBalancesInnerItemsInner {
	return &NullableTrialBsResponseTrialBsBalancesInnerItemsInner{value: val, isSet: true}
}

func (v NullableTrialBsResponseTrialBsBalancesInnerItemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsResponseTrialBsBalancesInnerItemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
