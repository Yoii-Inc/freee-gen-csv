...
// TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner struct for TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner
type TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner struct {
	// 期末残高
...
func NewTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner(id int32) *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner {
	this := TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner{}
	this.Id = id
	return &this
}
...
func (o TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) MarshalJSON() ([]byte, error) {
...
type NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner struct {
	value *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner
	isSet bool
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) Get() *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner {
	return v.value
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) Set(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner(val *TrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner {
	return &NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner{value: val, isSet: true}
}

func (v NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBsTwoYearsResponseTrialBsTwoYearsBalancesInnerSectionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
