...
// DealRenewsInnerDetailsInner struct for DealRenewsInnerDetailsInner
type DealRenewsInnerDetailsInner struct {
	// 勘定科目ID
...
func NewDealRenewsInnerDetailsInner(accountItemId int32, amount int64, entrySide string, id int64, tagIds []int32, taxCode int32, vat int32) *DealRenewsInnerDetailsInner {
	this := DealRenewsInnerDetailsInner{}
...
func (o *DealRenewsInnerDetailsInner) SetDescriptionNil() {
...
func (o *DealRenewsInnerDetailsInner) SetItemIdNil() {
	o.ItemId.Set(nil)
}
...
func (o *DealRenewsInnerDetailsInner) SetSectionIdNil() {
	o.SectionId.Set(nil)
}
...
func (o *DealRenewsInnerDetailsInner) SetSegment1TagIdNil() {
...
func (o *DealRenewsInnerDetailsInner) SetSegment2TagIdNil() {
...
func (o *DealRenewsInnerDetailsInner) SetSegment3TagIdNil() {
...
func (o DealRenewsInnerDetailsInner) MarshalJSON() ([]byte, error) {
...
type NullableDealRenewsInnerDetailsInner struct {
	value *DealRenewsInnerDetailsInner
	isSet bool
}

func (v NullableDealRenewsInnerDetailsInner) Get() *DealRenewsInnerDetailsInner {
	return v.value
}

func (v *NullableDealRenewsInnerDetailsInner) Set(val *DealRenewsInnerDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDealRenewsInnerDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDealRenewsInnerDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealRenewsInnerDetailsInner(val *DealRenewsInnerDetailsInner) *NullableDealRenewsInnerDetailsInner {
	return &NullableDealRenewsInnerDetailsInner{value: val, isSet: true}
}

func (v NullableDealRenewsInnerDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealRenewsInnerDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
