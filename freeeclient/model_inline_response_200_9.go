...
func NewInlineResponse2009(taxes []Tax) *InlineResponse2009 {
...
func (o *InlineResponse2009) GetTaxes() []Tax {
	if o == nil {
		var ret []Tax
		return ret
	}
...
func (o *InlineResponse2009) GetTaxesOk() (*[]Tax, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Taxes, true
...
func (o *InlineResponse2009) SetTaxes(v []Tax) {
	o.Taxes = v
}
