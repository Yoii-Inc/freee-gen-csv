...
`func NewExpenseApplicationUpdateParams(companyId int32, expenseApplicationLines []ExpenseApplicationUpdateParamsExpenseApplicationLines, issueDate string, title string, ) *ExpenseApplicationUpdateParams`
