...
// ApprovalRequestResponseApprovalRequestApprovers struct for ApprovalRequestResponseApprovalRequestApprovers
type ApprovalRequestResponseApprovalRequestApprovers struct {
	// 代理承認済みかどうか
...
func NewApprovalRequestResponseApprovalRequestApprovers(isForceAction bool, resourceType string, status string, stepId int32, userId NullableInt32) *ApprovalRequestResponseApprovalRequestApprovers {
	this := ApprovalRequestResponseApprovalRequestApprovers{}
...
func (o ApprovalRequestResponseApprovalRequestApprovers) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestResponseApprovalRequestApprovers struct {
	value *ApprovalRequestResponseApprovalRequestApprovers
	isSet bool
}

func (v NullableApprovalRequestResponseApprovalRequestApprovers) Get() *ApprovalRequestResponseApprovalRequestApprovers {
	return v.value
}

func (v *NullableApprovalRequestResponseApprovalRequestApprovers) Set(val *ApprovalRequestResponseApprovalRequestApprovers) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestResponseApprovalRequestApprovers) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestResponseApprovalRequestApprovers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestResponseApprovalRequestApprovers(val *ApprovalRequestResponseApprovalRequestApprovers) *NullableApprovalRequestResponseApprovalRequestApprovers {
	return &NullableApprovalRequestResponseApprovalRequestApprovers{value: val, isSet: true}
}

func (v NullableApprovalRequestResponseApprovalRequestApprovers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestResponseApprovalRequestApprovers) UnmarshalJSON(src []byte) error {
	v.isSet = true
