...
// ApprovalRequestResponseApprovalRequestComments struct for ApprovalRequestResponseApprovalRequestComments
type ApprovalRequestResponseApprovalRequestComments struct {
	// コメント内容
...
func NewApprovalRequestResponseApprovalRequestComments(comment string, postedAt string, userId int32) *ApprovalRequestResponseApprovalRequestComments {
	this := ApprovalRequestResponseApprovalRequestComments{}
...
func (o ApprovalRequestResponseApprovalRequestComments) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestResponseApprovalRequestComments struct {
	value *ApprovalRequestResponseApprovalRequestComments
	isSet bool
}

func (v NullableApprovalRequestResponseApprovalRequestComments) Get() *ApprovalRequestResponseApprovalRequestComments {
	return v.value
}

func (v *NullableApprovalRequestResponseApprovalRequestComments) Set(val *ApprovalRequestResponseApprovalRequestComments) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestResponseApprovalRequestComments) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestResponseApprovalRequestComments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestResponseApprovalRequestComments(val *ApprovalRequestResponseApprovalRequestComments) *NullableApprovalRequestResponseApprovalRequestComments {
	return &NullableApprovalRequestResponseApprovalRequestComments{value: val, isSet: true}
}

func (v NullableApprovalRequestResponseApprovalRequestComments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestResponseApprovalRequestComments) UnmarshalJSON(src []byte) error {
	v.isSet = true
