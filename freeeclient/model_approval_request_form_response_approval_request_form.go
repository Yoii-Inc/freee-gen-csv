...
type ApprovalRequestFormResponseApprovalRequestForm struct {
	...
	// 申請フォームの項目
	Parts *[]ApprovalRequestFormResponseApprovalRequestFormParts `json:"parts,omitempty"`
	// 適用された経路数
...
func (o *ApprovalRequestFormResponseApprovalRequestForm) GetParts() []ApprovalRequestFormResponseApprovalRequestFormParts {
	if o == nil || o.Parts == nil {
		var ret []ApprovalRequestFormResponseApprovalRequestFormParts
		return ret
	}
	return *o.Parts
}
...
// SetParts gets a reference to the given []ApprovalRequestFormResponseApprovalRequestFormParts and assigns it to the Parts field.
