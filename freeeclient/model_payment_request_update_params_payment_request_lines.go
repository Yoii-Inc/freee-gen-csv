...
// PaymentRequestUpdateParamsPaymentRequestLines struct for PaymentRequestUpdateParamsPaymentRequestLines
type PaymentRequestUpdateParamsPaymentRequestLines struct {
	// 勘定科目ID
...
func NewPaymentRequestUpdateParamsPaymentRequestLines(amount int32) *PaymentRequestUpdateParamsPaymentRequestLines {
	this := PaymentRequestUpdateParamsPaymentRequestLines{}
	this.Amount = amount
	return &this
}
...
func (o *PaymentRequestUpdateParamsPaymentRequestLines) SetAccountItemIdNil() {
...
func (o PaymentRequestUpdateParamsPaymentRequestLines) MarshalJSON() ([]byte, error) {
...
type NullablePaymentRequestUpdateParamsPaymentRequestLines struct {
	value *PaymentRequestUpdateParamsPaymentRequestLines
	isSet bool
}

func (v NullablePaymentRequestUpdateParamsPaymentRequestLines) Get() *PaymentRequestUpdateParamsPaymentRequestLines {
	return v.value
}

func (v *NullablePaymentRequestUpdateParamsPaymentRequestLines) Set(val *PaymentRequestUpdateParamsPaymentRequestLines) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentRequestUpdateParamsPaymentRequestLines) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentRequestUpdateParamsPaymentRequestLines) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentRequestUpdateParamsPaymentRequestLines(val *PaymentRequestUpdateParamsPaymentRequestLines) *NullablePaymentRequestUpdateParamsPaymentRequestLines {
	return &NullablePaymentRequestUpdateParamsPaymentRequestLines{value: val, isSet: true}
}

func (v NullablePaymentRequestUpdateParamsPaymentRequestLines) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentRequestUpdateParamsPaymentRequestLines) UnmarshalJSON(src []byte) error {
	v.isSet = true
