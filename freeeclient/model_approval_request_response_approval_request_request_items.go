...
// ApprovalRequestResponseApprovalRequestRequestItems struct for ApprovalRequestResponseApprovalRequestRequestItems
type ApprovalRequestResponseApprovalRequestRequestItems struct {
	// 項目ID
	Id int32 `json:"id"`
...
func NewApprovalRequestResponseApprovalRequestRequestItems(id int32, type_ string, value string) *ApprovalRequestResponseApprovalRequestRequestItems {
	this := ApprovalRequestResponseApprovalRequestRequestItems{}
	this.Id = id
	this.Type = type_
	this.Value = value
	return &this
...
func (o ApprovalRequestResponseApprovalRequestRequestItems) MarshalJSON() ([]byte, error) {
...
type NullableApprovalRequestResponseApprovalRequestRequestItems struct {
	value *ApprovalRequestResponseApprovalRequestRequestItems
	isSet bool
}

func (v NullableApprovalRequestResponseApprovalRequestRequestItems) Get() *ApprovalRequestResponseApprovalRequestRequestItems {
	return v.value
}

func (v *NullableApprovalRequestResponseApprovalRequestRequestItems) Set(val *ApprovalRequestResponseApprovalRequestRequestItems) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestResponseApprovalRequestRequestItems) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestResponseApprovalRequestRequestItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestResponseApprovalRequestRequestItems(val *ApprovalRequestResponseApprovalRequestRequestItems) *NullableApprovalRequestResponseApprovalRequestRequestItems {
	return &NullableApprovalRequestResponseApprovalRequestRequestItems{value: val, isSet: true}
}

func (v NullableApprovalRequestResponseApprovalRequestRequestItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestResponseApprovalRequestRequestItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
