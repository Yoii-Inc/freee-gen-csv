...
// ReceiptResponseReceipt struct for ReceiptResponseReceipt
type ReceiptResponseReceipt struct {
	// 作成日時（ISO8601形式）
...
func (o ReceiptResponseReceipt) MarshalJSON() ([]byte, error) {
...
type NullableReceiptResponseReceipt struct {
	value *ReceiptResponseReceipt
	isSet bool
}

func (v NullableReceiptResponseReceipt) Get() *ReceiptResponseReceipt {
	return v.value
}

func (v *NullableReceiptResponseReceipt) Set(val *ReceiptResponseReceipt) {
	v.value = val
	v.isSet = true
}

func (v NullableReceiptResponseReceipt) IsSet() bool {
	return v.isSet
}

func (v *NullableReceiptResponseReceipt) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReceiptResponseReceipt(val *ReceiptResponseReceipt) *NullableReceiptResponseReceipt {
	return &NullableReceiptResponseReceipt{value: val, isSet: true}
}

func (v NullableReceiptResponseReceipt) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReceiptResponseReceipt) UnmarshalJSON(src []byte) error {
	v.isSet = true
